...
global_gpu_scheduler = None


@app.route("/run_task/", methods=['POST'])
def handle_run_task():
    global global_gpu_scheduler
    ...
    global_gpu_scheduler.state.add_local_task(gpu_scheduler_state.Task(
        name=task_name,
        cmd=task_cmd,
    ...
    global_gpu_scheduler.state.changed.set()
